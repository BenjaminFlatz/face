import screeninfo
import argparse
from FaceRecognition.ImageFaceRecognitionService import ImageFaceRecognitionService
from FaceRecognition.ScreenFaceRecognitionService import ScreenFaceRecognitionService
from FaceRecognition.CameraFaceRecognitionService import CameraFaceRecognitionService
...
if __name__ == '__main__':
    ...
    parser.add_argument("-f", "--factor", help="down scale factor for image processing", default=2, type=int)
    ...
    fr = ImageFaceRecognitionService(args.directory, width, height, args.factor)
    fr.Run()
